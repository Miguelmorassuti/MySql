...
#2 subqueries como se ela fosse colunas uma coluna para media do departamento, uma para a media geral
...
#utilizar count  para somar a quantidade de funcionarios e sum para contar as horas (2 subquaries)
...
# 1° calcular media de horas de projetos, pesquisar como mostrar apenas os 3 registros
